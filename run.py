...
def cave():
    ...
    print("He insists the only gun onboard belongs to him and to himself only... while my life gets to depend on him.")
    ...
    print("I saw him changing the password for the holster, it is the anthropolists first name...")
